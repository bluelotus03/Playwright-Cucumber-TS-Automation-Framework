...
(0, _cucumber.Then)(/^the "([^"]*)" (?:radio button|check box|switch) should( not)? be checked$/, /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("the ".concat(elementKey, " radio button|check box|switch should ").concat(negate ? 'not ' : '', "be checked"));
