      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("the ".concat(elementKey, " on the ").concat(iframeName, " iframe should ").concat(negate ? 'not ' : '', "contain the text ").concat(expectedElementText));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _logger.logger.log("the ".concat(elementKey, " on the ").concat(iframeName, " iframe should ").concat(negate ? 'not ' : '', "equal the text ").concat(expectedElementText));
