...
(0, _cucumber.Then)(/^I (check)?(uncheck)? the "([^"]*)" (?:radio button|check box)$/, /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log("I ".concat(unchecked ? 'uncheck ' : 'check', " the ").concat(elementKey, " radio button|check box"));
